...
-- CreateIndex
CREATE INDEX "Consultation_clinicId_createdAt_idx" ON "Consultation"("clinicId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialCategory_clinicId_name_type_key" ON "FinancialCategory"("clinicId", "name", "type");

-- CreateIndex
CREATE INDEX "Transaction_clinicId_date_idx" ON "Transaction"("clinicId", "date");
...
-- AddForeignKey
ALTER TABLE "FinancialCategory" ADD CONSTRAINT "FinancialCategory_clinicId_fkey" FOREIGN KEY ("clinicId") REFERENCES "Clinic"("id") ON DELETE CASCADE ON UPDATE CASCADE;
